    ...
    return (
        <section className="container mx-auto px-6 py-24">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-primary mb-3">Featured Deployments</h2>
                    <p className="text-muted max-w-2xl">A curated selection of elite engineering capabilities mapping frontend UI to heavy database loads.</p>
                </div>
